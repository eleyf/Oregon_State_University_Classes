...
void World::setPlayer(Creature * f, int p)
{
	player[p] = f;
}
...
**  
********************************************************************/
void World::createPlayer(int p, int n)
{
	int characterChoice;

	// Display menu
	std::cout << std::endl;
	std::cout << "   Choose Player " << p + 1 << " Character " << n << std::endl << std::endl;
	...
	std::cout << std::endl << "Enter the choice of the character for player " << p + 1 << " you want to utilize (1 - 5)";
	std::cout << std::endl;
...
int World::war()
{
	...
	if (player[1]->getLives() <= 0) //player 1 wins
	{
